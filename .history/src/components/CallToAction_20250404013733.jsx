            ...
            <section className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <h2 className="mt-8 text-3xl font-bold leading-tight text-black lg:mt-12 sm:text-4xl lg:text-5xl">বৃত্ত লার্নিং-এ আজই <span className="border-b-8 border-yellow-300">যোগ দিন</span> other developers</h2>
