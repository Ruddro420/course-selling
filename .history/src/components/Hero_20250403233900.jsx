...
const HeroWithBackgroundAnimation = () => {
  return (
    <div className="hero-container">
      <section className="py-10 sm:py-16 lg:py-24 animated-bg">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 lg:gap-12 lg:grid-cols-1">
            <div className="order-2 lg:order-1 mt-0 lg:mt-0 pb-6 lg:pb-0">
              ...
              <h1 className="mt-4 text-4xl lg:text-2xl font-bold lg:leading-22 leading-12 text-black lg:mt-4 sm:text-6xl xl:text-7xl">
                স্কিল শিখে গড়ুন আপনার <span>স্বাধীন ভবিষ্যৎ</span> !
              </h1>
...
export default HeroWithBackgroundAnimation;
