...
const Header = () => {
  ...
  return (
    <div>
      <nav className=" fixed px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 z-[999] top-0 start-0">
        <div className=" flex flex-wrap items-center justify-between mx-auto px-6 lg:px-8 py-4">
