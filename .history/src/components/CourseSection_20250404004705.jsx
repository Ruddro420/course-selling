          ...
          <div className="block-bg  p-6 mt-4 rounded-b-lg">
            ...
            {isCoursePurchased(course.course_name) ? (
              ...
              <Link to={`/course/${course.id}`} className="p-0 cursor-pointer">
                <button className="w-full cursor-pointer bg-transparent text-white py-3 rounded-lg font-semibold hover:bg-yellow-400 hover:text-black transition duration-300 mt-4">
                  Enroll Now
                </button>
              </Link>
            )}
