                  ...
                  <div className="p-5">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">
                      <span className="text-4xl font-semibold text-black tracking-tighter">
                        <Bn content={course.discount_price ? course.discount_price : course.course_price} /> ৳
                      </span>
                    </h5>
                  ...
                  <div className="">
                    <h3 className="text-lg  font-bold text-black tracking-wide uppercase px-6 py-2">
                      ...
                      <li  className="flex space-x-3 items-center px-6">
                        ...
                        <span className="text-base text-black">ক্লাস সপ্তাহ ঃ {course.course_week}</span>
                      </li>
                      <li  className="flex space-x-3 items-center px-6">
                        <IoBookOutline className="flex-shrink-0  h-5 w-5 text-[#0BA3C4]" />
                        <span className="text-base text-black">{course.video_count}</span>
                      </li>
