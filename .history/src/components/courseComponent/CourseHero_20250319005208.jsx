                ...
                <div className="relative bg-white rounded-lg shadow-sm ">
                  ...
                  <div className="p-4 md:p-5">
                    <form className="space-y-4" action="#">
                      ...
                      <button type="submit" className="w-full cursor-pointer text-white bg-[#12C1DF] hover:[#FCD34D] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center">Register to your account</button>
                    </form>
                  </div>
                </div>
              </div>
