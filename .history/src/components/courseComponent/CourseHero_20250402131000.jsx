...
const CourseHero = ({ course }) => {
  ...
  // load context
  const { user, loginData, otp } = useContext(DataContext);
              ...
              <div className="p-4 md:p-5">
                {
                  otp ? <form className="space-y-4" onSubmit={submitOTP}>
                    <div>
                      ...
                      <input type="number" name="number" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="OTP" required />
                    </div>
                    ...
                    <div>
                      ...
                      <input type="number" name="number" id="phone_number" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="01755 XXXXXX" required />
                    </div>
