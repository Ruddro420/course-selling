...
const CourseSection = () => {
  ...
  <div class="text-center mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Lead Generation Mastery</h1>
    <p class="text-sm text-gray-500 mt-2">FROM BASICS TO BRILLIANCE</p>
  </div>


  <div class="bg-blue-50 p-6 rounded-lg mb-6">
    <h2 class="text-xl font-semibold text-blue-800">Lead Generation Mastery</h2>
    <p class="text-sm text-gray-600 mt-1">By Britto Learning</p>
  </div>


  <div class="flex justify-between items-center mb-6">
    <div>
      <p class="text-2xl font-bold text-gray-800">499.00</p>
