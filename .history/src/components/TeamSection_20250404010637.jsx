        ...
        <div>
            <section className="py-10 bg-gray-50 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <div classNameName="grid grid-cols-2 mt-8 text-center sm:mt-16 lg:mt-20 sm:grid-cols-4 gap-y-8 lg:grid-cols-3 gap-x-0">
                        {teamData.map((member, index) => (
                            <div key={index}>
                                <img
                                    classNameName="object-cover mx-auto rounded-lg w-40 h-auto sm:w-52 sm:h-auto lg:w-44 lg:h-auto"
                                    src={member.image}
                                    alt={member.name}
                                />
                                <p classNameName="mt-8 text-lg font-semibold leading-tight text-black">{member.name}</p>
                                <p classNameName="mt-1 text-base leading-tight text-gray-600">{member.role}</p>
                            </div>
                        ))}
                    </div>
                </div>
