          ...
          <div className="block-bg  p-6 mt-4 rounded-b-lg">
            ...
            {isCoursePurchased(course.course_name) ? (
              <Link to={`/course-content/${course.course_name}`} className="p-0 cursor-pointer">
                <button className="w-full cursor-pointer button-bgtext-white py-3 rounded-lg font-semibold hover:bg-[#FBCD16] transition duration-300 mt-4 hover:text-black">
                  View Course
                </button>
              </Link>
            ) : (
