            ...
            <section className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <p className="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">ছাত্র ছাত্রীরা তাদের কাজ শেখার এক্সপেরিয়েন্স শেয়ার করেছে এগুলো !</p>
                    </div>

                    <div className="grid grid-cols-1 gap-6 px-4 mt-12 sm:px-0 xl:mt-20 xl:grid-cols-4 sm:grid-cols-2">
                        <div className="overflow-hidden block-bg rounded-md">
