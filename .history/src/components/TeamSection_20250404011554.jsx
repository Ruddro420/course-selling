        ...
        <div className='course-container'>
            <section className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-3 mt-10">
                        {teamData.map((member, index) => (
                            <div key={index} className="items-center block-bg rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div className="p-5">
                                    ...
                                    <span className="text-gray-500 dark:text-gray-400 mb-5">{member.role}</span>

                                    <div>
                                        <ul className="flex space-x-4 sm:mt-0 mt-10">
                                            <li>
