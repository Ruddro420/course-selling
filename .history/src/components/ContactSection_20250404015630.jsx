                ...
                <form action={"https://formspree.io/f/manepjqb"} onSubmit={onSubmit} className="mt-14" method="POST">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div className="sm:col-span-2">
                      <button
                        type="submit"
                        className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-[#0aa4bf] border border-transparent rounded-md focus:outline-none hover:bg-[0aa4bf] focus:bg-blue-700"
                      >
                        Send
                      </button>
                    </div>
