        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 lg:gap-12 lg:grid-cols-2">
            <div className="order-2 lg:order-1 mt-0 lg:mt-0 pb-6 lg:pb-0">
              ...
              <h1 className="mt-4 text-4xl lg:text-2xl font-bold lg:leading-22 leading-12 text-black lg:mt-4 sm:text-6xl xl:text-5xl">
            ...
            <div className="order-1 lg:order-2 mt-20 lg:mt-0">
              <img className="" src="https://brittolearning.com/wp-content/uploads/2025/04/b7f3f6d7-ad85-46bc-b41a-fa22ce7113c0.png" alt="" />
            </div>
          </div>
        </div>
      </section>
