                    ...
                    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                            <div>
                                ...
                                <a href="#" title="" className="inline-flex items-center px-6 py-4 mt-2 font-semibold text-black transition-all duration-200 bg-yellow-300 rounded-full lg:mt-5 hover:bg-yellow-400 focus:bg-yellow-400" role="button">
                                চলুন শিখা শুরু করি
