                        ...
                        <div className="w-1/4 bg-white p-5  overflow-auto rounded-md border-2 border-gray-200">
                            ...
                            <ul>
                                {courses.map((course) => (
                                    <li
                                        key={course.id}
                                        className={`p-3 mb-5 cursor-pointer flex justify-between items-center rounded border-t-2 border-gray-200 ${selectedCourse.id === course.id ? 'bg-blue-500 text-white' : 'white'}`}
