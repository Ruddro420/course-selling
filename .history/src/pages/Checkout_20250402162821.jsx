                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div className="ms-4 text-sm">
                                                ...
                                                <div className='mt-5'>
                                                    ...
                                                    <input type="number" id="your_name" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="0878677" required />
                                                </div>
                                                <div className='mt-5'>
