            ...
            <section className="bg-opacity-30 py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex h-screen ">
                        {/* Sidebar */}
                        <div className="w-1/3 bg-white p-5 overflow-auto rounded-md border-2 border-gray-100 max-h-fit">
                            <h2 className="text-xl font-bold mb-4">Course Content</h2>
                            <ul>
                                {courses.map((course) => (
                                    <li
                                        key={course.id}
                                        className={`p-3 mb-2 cursor-pointer flex justify-between items-center rounded border-2 border-gray-200 ${selectedCourse.id === course.id ? 'bg-blue-500 text-white' : 'white'}`}
                        ...
                        <div className="flex-1 flex flex-col px-5 space-y-4">
                            ...
                            <div className="bg-white p-4 rounded-lg border-2 border-gray-200">
                                ...
                                <div className="w-full bg-gray-200 rounded">
                                    <div className="bg-blue-600 text-xs font-medium text-blue-100 text-center p-2 leading-none rounded" style={{ width: "45%" }}> 45%</div>
                                </div>
                            </div>
