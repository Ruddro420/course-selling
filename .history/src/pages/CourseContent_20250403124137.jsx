...
export default function CourseContent() {
    ...
    const isPurchased = purchasedCourses.data?.some(item => console.log(item));
    // console.log(id);
    

    // If purchased, redirect to a different page (e.g., dashboard)
    if (isPurchased) {
        toast.success('You Have To Purchases The Course');
    ...
    return (
        <>
            {
                loading ? <Loader /> : <section className="bg-opacity-30 py-24 sm:py-16 lg:py-24">
                        ...
                        <div className="flex lg:flex-row flex-col lg:h-screen">
                            ...
                            <div className="flex-1 flex flex-col px-5 space-y-4">
                                ...
                                <div className="bg-white p-4 rounded-lg shadow-md">
                                    ...
                                    <p className="text-gray-600">1. {selectedCourse.module_des}</p>
                                </div>
