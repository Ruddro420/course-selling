                        ...
                        <div className="w-1/3 bg-white p-5 overflow-auto rounded-md border-2 border-gray-200 max-h-fit">
                            ...
                            <ul>
                                {courses.map((course) => (
                                    <li
                                        key={course.id}
                                        className={`p-3 mb-2 cursor-pointer flex justify-between items-center rounded border-2 border-gray-100 ${selectedCourse.id === course.id ? 'bg-blue-500 text-white' : 'white'}`}
