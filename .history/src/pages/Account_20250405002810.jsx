...
const Account = () => {
    const { logOut, purchasedCourses, user, courseLoading } = useContext(DataContext)
    return (
        <div>
            {
                courseLoading ? <Loader /> : <section className="course-container pt-18 antialiased ">
                    <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center justify-between p-6 bg-black text-white rounded-lg">
                            ...
                            <div>
                                ...
                                <div className="mt-4">
                                    {/* <button className="course-container text-black py-2 px-4 rounded-md mr-2 cursor-pointer">My Courses</button> */}
                                    <button onClick={() => logOut()} className="bg-[red] text-white py-2 px-4 rounded-md cursor-pointer">Logout</button>
                                </div>
                            </div>


                            <div className="course-container text-black p-6 rounded-lg flex flex-col items-center">
