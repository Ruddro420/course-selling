...
const courses = [
    ...
    { id: 2, title: "Setting Up the Environment (React-Redux)", video: "19hIRJ3Y5Y5-v12sBS3q00E3_RHKedcHu" },
                        ...
                        <div className="flex-1 flex flex-col px-5 space-y-4">
                            ...
                            <div className="flex justify-between">
                                <button
                                    ...
                                    className={`px-5 py-2 rounded-md text-white ${selectedCourseIndex === 0 ? "bg-gray-400 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-600"
                                        }`}
                                >
                                    Previous Topic
                                </button>
                                ...
                                <button
                                    ...
                                    className={`px-5 py-2 rounded-md text-white ${selectedCourseIndex === courses.length - 1 ? "bg-gray-400 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-600"
                                        }`}
                                >
                                    Next Topic
                                </button>
