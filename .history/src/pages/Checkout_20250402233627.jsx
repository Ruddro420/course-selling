...
const Checkout = () => {
    ...
    // Debugging log to see if data is being fetched correctly
    useEffect(() => {
        if (getCourseApiData?.data) {
            console.log("getCourseApiData loaded:", getCourseApiData.data);
            ...
            console.log("getCourseApiData is not yet loaded");
        }

        // Set the user from localStorage
        const userFromStorage = JSON.parse(localStorage.getItem("signUp"));
    ...
    const handleSubmit = async (e) => {
        ...
        // Log user to see if it's correct
    ...
    if (!data) {
        return <div>Loading course data...</div>; // Show loading state until data is loaded
    }
                ...
                <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16 border-gray-200 shadow-lg rounded py-16 p-8">
                    <div className="min-w-0 flex-1 space-y-8">
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label htmlFor="your_address" className="mb-2 block text-sm font-medium text-gray-900">Your Address</label>
                                    <input
                                        type="text"
                                        id="your_address"
                                        className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500"
                                ...
                                {data?.course_price === 0 ? (
                                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 ">
                                        <div className="flex items-start">
                                            <div className="flex h-5 items-center">
                                                <input
                                                    id="free-course"
                                                    aria-describedby="free-course-text"
                                                    type="radio"
                                                    name="payment-method"
                                                    value=""
                                            ...
                                            <div className="ms-4 text-sm">
                                                <label htmlFor="free-course" className="font-medium leading-none text-gray-900">
                                                    Free
                                                </label>
                                                <p id="free-course-text" className="mt-1 text-xs font-normal text-gray-500 ">
                                                    Free Course
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 ">
                                        <div className="flex items-start">
                                            ...
                                            <div className="ms-4 text-sm">
                                                <label htmlFor="bkash" className="font-medium leading-none text-gray-900">
                                                    Bkash
                                                </label>
                                                ...
                                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                    <div className="mt-5">
                                                        <label htmlFor="bkash_no" className="mb-2 block text-sm font-medium text-gray-900">
                                                            Enter Bkash Number
                                                        </label>
                                                        <input
                                                            type="number"
                                                    ...
                                                    <div className="mt-5">
                                                        <label htmlFor="tax_id" className="mb-2 block text-sm font-medium text-gray-900">
                                                            Enter Bkash TaxIN Number
                                                        </label>
                                                        <input
                                                            type="text"
                                                            id="tax_id"
                    ...
                    <div className="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                        ...
                        <div className="space-y-3">
                            <button type="submit" className="flex w-full items-center justify-center rounded-lg bg-[#29C8E3] px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 cursor-pointer">
                                Proceed to Payment
                            </button>
                        </div>
                    </div>
