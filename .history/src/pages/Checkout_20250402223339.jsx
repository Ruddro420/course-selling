                                                ...
                                                <div className="ms-4 text-sm">
                                                    ...
                                                    <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
                                                        <div className='mt-5'>
                                                            ...
                                                            <input type="number" id="your_name" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="017555234553" required />
                                                        </div>
                                                        <div className='mt-5'>
                                                            <label htmlFor="your_name" className="mb-2 block text-sm font-medium text-gray-900"> Enter Bksh TaxIN Number</label>
                                                            <input type="text" id="your_name" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="sdSDAIW" required />
                                                        </div>
                                                    </div>
