                ...
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="flex items-end justify-between">
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600 lg:mx-0">য়ামাদের সেরা কিছু কোর্স যেগুলো আপনাদের দক্ষ করতে যথেষ্ট সাহায্য করবে।</p>
                        </div>
                        ...
                        <div className="">
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md mx-auto">
                                ...
                                <div className="text-center mb-6">
                                    <h1 className="text-2xl font-bold text-gray-800">Lead Generation Mastery</h1>
